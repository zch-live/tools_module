...
public class WheelToolsView extends View implements Runnable {
    @Deprecated
    ...
    public WheelToolsView(Context context) {
        this(context, null);
    }

    public WheelToolsView(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.WheelStyle);
    }

    public WheelToolsView(Context context, AttributeSet attrs, int defStyleAttr) {
